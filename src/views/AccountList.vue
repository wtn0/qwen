<template>
  <div class="account-list-page">
    ...
    <div class="page-header">
      ...
      <button class="btn btn-primary" @click="handleAdd">+ 新建账号</button>
    </div>
          ...
          <tr v-for="item in paginatedData" :key="item.id">
            ...
            <td>
              <div class="account-info">
                <div class="avatar" :style="{ background: avatarColor(item.name) }">
            ...
            <td>
              <span class="tag" :class="'tag-' + item.role">
                {{ roleLabel(item.role) }}
              </span>
            </td>
            <td>
            ...
            <td class="cell-actions">
              <button class="btn btn-sm btn-outline" @click="handleEdit(item)">编辑</button>
              <button class="btn btn-sm btn-outline" @click="handleView(item)">查看</button>
              <button
                class="btn btn-sm"
                :class="item.status === 'active' ? 'btn-danger-outline' : 'btn-success-outline'"
...
function roleLabel(role) {
  const map = { admin: '管理员', editor: '编辑者', viewer: '观察者' }
...
function handleEdit(item) {
  alert(`编辑账号: ${item.name}`)
}

function handleView(item) {
  alert(`查看账号: ${item.name}`)
}
